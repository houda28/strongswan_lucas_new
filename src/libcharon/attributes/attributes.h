...
enum configuration_attribute_type_t {
    ...
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_VERSION = 19428,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_INI_FORMAT = 19429,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_XML_FORMAT = 19430,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_XML_DEFLATE_FORMAT = 19431,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_ORIGINAL_LENGTH = 19432,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_REGISTRATION_ID = 19433,
    ISAKMP_MODECFG_ATTRIB_SONICWALL_POLICY_CLIENT_RELEASE_ID = 19434,
