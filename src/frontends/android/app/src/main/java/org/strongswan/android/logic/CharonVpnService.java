...
//							writer.setValue("connection.version",1);
//							writer.setValue("connection.aggressive", true);
//							writer.setValue("connection.xauth", true);
//							writer.setValue("connection.xauth_identity",1);
